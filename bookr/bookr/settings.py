...
# It is used for hashing, tokens, and other cryptographic functions.
# If you had existing sessions in a cookie and changed this value, the sessions would no longer be valid.
SECRET_KEY = 'django-insecure-17f67=w)0u1o+93(h!8_4tnr*0^$)ljhlrv1*4+45hz8-xixko'
